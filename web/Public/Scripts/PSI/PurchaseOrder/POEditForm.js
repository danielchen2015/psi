...
Ext.define("PSI.PurchaseOrder.POEditForm", {
	...
	initComponent : function() {
		...
		Ext.apply(me, {
			...
			items : [{
						...
						items : [{
									...
									id : "PSI_PurchaseOrder_POEditForm_editDealDate",
									fieldLabel : "交货日期",
									labelWidth : 60,
									labelAlign : "right",
									labelSeparator : "",
		...
		me.__editorList = ["PSI_PurchaseOrder_POEditForm_editDealDate",
		...
		me.editDealDate = Ext
				.getCmp("PSI_PurchaseOrder_POEditForm_editDealDate");
		me.editSupplier = Ext
	...
	onSelectPCTemplate : function() {
		var form = Ext.create("PSI.PurchaseOrder.POSelectPCTemplateForm", {
					parentForm : this
				});
