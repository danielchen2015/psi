...
Ext.define("PSI.Inventory.InitInventoryMainForm", {
	...
	initComponent : function() {
		...
		Ext.define("PSIInitInv", {
					...
					fields : ["id", "goodsId", "goodsCode", "goodsName",
							"goodsSpec", "goodsCount", "goodsUnit",
							"goodsMoney", "goodsPrice", "initDate"]
				});
	...
	getDetailGrid : function() {
		...
		var modelName = "PSIInitInvDetail";
		Ext.define(modelName, {
					extend : "Ext.data.Model",
					fields : ["id", "goodsCode", "goodsName", "goodsSpec",
							"goodsCount", "goodsUnit", "goodsMoney",
							"goodsPrice", "initDate", "qcBeginDT", "qcDays",
							"qcEndDT", "qcSN"]
				});
		...
		me.__detailGrid = Ext.create("Ext.grid.Panel", {
					...
					header : {
						height : 30,
						title : me.formatGridHeaderTitle("物资 - 保质期明细")
					},
					columnLines : true,
					columns : [{
								header : "物资编码",
	...
	refreshDetailGrid : function() {
		...
		el.mask(PSI.Const.LOADING);
		var r = {
			url : me.URL("Home/InitInventory/goodsDetailList"),
			params : {
				warehouseId : warehouse.get("id"),
