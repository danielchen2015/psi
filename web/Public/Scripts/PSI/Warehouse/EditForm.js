...
Ext.define("PSI.Warehouse.EditForm", {
	...
	initComponent : function() {
		...
		Ext.apply(me, {
					...
					items : [{
								...
								items : [{
									...
									id : "PSI_Warehouse_EditForm_editOrgName",
									...
									id : "PSI_Warehouse_EditForm_editLastAdd",
									xtype : "displayfield"
								}],
								buttons : buttons
							}]
		...
		me.editOrgName = Ext.getCmp("PSI_Warehouse_EditForm_editOrgName");
		me.hiddenOrgId = Ext.getCmp("PSI_Warehouse_EditForm_hiddenOrgId");
		me.editLastAdd = Ext.getCmp("PSI_Warehouse_EditForm_editLastAdd");
	},
	...
	setOrg : function(data) {
		...
		me.hiddenOrgId.setValue(data.id);
	},
	...
	onEditNameSpecialKey : function(field, e) {
		...
		if (e.getKey() == e.ENTER) {
			me.editOrgName.focus();
			me.editOrgName.setValue(me.editOrgName.getValue());
		}
	},
