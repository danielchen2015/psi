...
Ext.define("PSI.Supplier.CategoryEditForm", {
	...
	initComponent : function() {
		...
		Ext.apply(me, {
			...
			items : [{
						...
						items : [{
									...
									id : "PSI_Supplier_CategoryEditForm_editParentCategory",
									fieldLabel : "上级分类",
									xtype : "psi_supplierparentcategoryfield",
									listeners : {
										specialkey : {
											fn : me.onEditParentCategorySpecialKey,
											scope : me
										}
									}
								}, {
									id : "PSI_Supplier_CategoryEditForm_editParentCategoryId",
									name : "parentId",
									xtype : "hidden"
								}],
						buttons : buttons
		...
		me.editParentCategory = Ext
				.getCmp("PSI_Supplier_CategoryEditForm_editParentCategory");
		me.editParentId = Ext
				.getCmp("PSI_Supplier_CategoryEditForm_editParentCategoryId");
	},

	onOK : function(thenAdd) {
		var me = this;

		me.editParentId.setValue(me.editParentCategory.getIdValue());
	...
	onEditNameSpecialKey : function(field, e) {
		...
		if (e.getKey() == e.ENTER) {
			...
			me.editParentCategory.setValue(me.editParentCategory.getValue());
		}
	},

	onEditParentCategorySpecialKey : function(field, e) {
		var me = this;
	...
	onWndShow : function() {
		...
		Ext.Ajax.request({
					url : me.URL("/Home/Supplier/categoryInfo"),
					params : {
