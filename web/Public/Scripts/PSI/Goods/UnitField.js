 ...
 * 自定义字段 - 商品计量单位字段
 */
Ext.define("PSI.Goods.UnitField", {
	...
	onTriggerClick : function(e) {
		...
		var wnd = Ext.create("Ext.window.Window", {
			...
			items : [{
						...
						items : [{
							...
							bodyPadding : 5,
							items : [{
										id : "PSI_Goods_UnitField_editGoodsUnit",
										xtype : "textfield",
										fieldLabel : "计量单位",
										labelWidth : 70,
										labelAlign : "right",
		...
		var editName = Ext.getCmp("PSI_Goods_UnitField_editGoodsUnit");
		editName.on("change", function() {
			var store = me.lookupGrid.getStore();
			Ext.Ajax.request({
						url : PSI.Const.BASE_URL + "Home/Goods/queryUnitData",
						params : {
							goodsId : me.getGoodsId(),
	...
	onOK : function() {
		...
		if (me.getParentCmp() && me.getParentCmp().__setGoodsUnitInfo) {
