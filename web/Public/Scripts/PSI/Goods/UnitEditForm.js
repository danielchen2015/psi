...
Ext.define("PSI.Goods.UnitEditForm", {
	...
	initComponent : function() {
		...
		var logoHtml = "<img style='float:left;margin:10px 20px 0px 10px;width:88px;height:88px;' src='"
				+ PSI.Const.BASE_URL
				+ "Public/Images/"
				+ f
				+ "'></img>"
				...
				+ "<p style='color:#196d83'>助记码为空的时候后台自动生成助记码</p>";
		...
		Ext.apply(me, {
					...
					items : [{
								...
								items : [{
									...
									id : "PSI_Goods_UnitEditForm_editPY",
									fieldLabel : "助记码",
									name : "py",
									value : entity == null ? null : entity
											.get("py"),
		...
		me.editPY = Ext.getCmp("PSI_Goods_UnitEditForm_editPY");
	},
	...
	refreshParentFormMainGrid : function(id) {
		var me = this;
	...
	onEditPYSpecialKey : function(field, e) {
		var me = this;
