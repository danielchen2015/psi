 ...
 * @author 李静波
 */
class InventoryService extends PSIBaseExService {
	...
	public function inventoryQcList($params) {
		...
		$dao = new InventoryDAO($this->db());
		return $dao->inventoryQcList($params);
	}
	...
	public function inventoryQcDetailList($params) {
		...
		$dao = new InventoryDAO($this->db());
		return $dao->inventoryQcDetailList($params);
	}
}