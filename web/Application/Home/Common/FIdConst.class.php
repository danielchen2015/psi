...
class FIdConst {
	 ...
	 * @var string
	 */
	const SCM_PURCHASE_CONTRACT = "3001";
	 ...
	 * @var string
	 */
	const SCM_SPO_GEN_POBILL = "3002-05";
	 ...
	 * @var string
	 */
	const SCM_LOGISTICS_DISTRIBUTION = "3003";
	 ...
	 * @var string
	 */
	const SCM_LOGISTICS_DISTRIBUTION_ADD = "3003-01";
	 ...
	 * @var string
	 */
	const SCM_LOGISTICS_DISTRIBUTION_EDIT = "3003-02";
	 ...
	 * @var string
	 */
	const SCM_LOGISTICS_DISTRIBUTION_DELETE = "3003-03";
	 ...
	 * @var string
	 */
	const SCM_LOGISTICS_DISTRIBUTION_COMMIT = "3003-04";
	 ...
	 * @var string
	 */
	const SCM_LOGISTICS_DISTRIBUTION_PRINT = "3003-05";
	 ...
	 * @var string
	 */
	const SCM_LOGISTICS_DISTRIBUTION_COMMIT_REJ = "3003-06";
	 ...
	 * @var string
	 */
	const SCM_STORE_US_TEMPLATE_MANAGEMENT = "3005";
	
	/**
	 * 门店盘点
	 */
	const SCM_STORE_US = "3006";
	
	/**
	 * 门店盘点 - 新建消耗单
	 */
	const SCM_STORE_US_ADD = "3006-01";
	
	/**
	 * 门店盘点 - 编辑消耗单
	 */
	const SCM_STORE_US_EDIT = "3006-02";
	
	/**
	 * 门店盘点 - 删除消耗单
	 */
	const SCM_STORE_US_DELETE = "3006-03";
	
	/**
	 * 门店盘点 - 提交更新库存
	 */
	const SCM_STORE_US_COMMIT = "3006-04";

	//add by daniel 2019/3/20
    /**
     * 员工管理
     */
    const EMPLOYEE_MANAGEMENT = "-4001";

    /**
     * 员工管理 - 新增员工信息
     */
    const EMPLOYEE_MANAGEMENT_ADD_ORG = "-4001-01";

    /**
     * 员工管理 - 编辑员工信息
     */
    const EMPLOYEE_MANAGEMENT_EDIT_ORG = "-4001-02";
}
